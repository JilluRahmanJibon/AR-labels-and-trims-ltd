  ...
  return (
    ...
    >
      <div className={`w-full h-full bg-[#2c3e504f] flex items-center justify-center text-white z-10`}>
        ...
        <h1 className={`${ props.webTittle ? "hidden" : "" } font-[500] xl:!text-[4rem] lg:!text-[3.5rem] md:!text-[3rem] sm:!text-[2.5rem] [@media(min-width:400px)]:text-[2rem] text-[1.5rem] GeologicaFont drop-shadow-[0_0_1px_#000000ff] text-[#c9eb61]`}>{props.tittle}</h1>
      </div>
    </main>
  );
}

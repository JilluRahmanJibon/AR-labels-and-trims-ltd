              ...
              <form>
                ...
                <div className="mb-[12px] text-left">
                  <label className="relative">
                    ...
                    <FaEyeSlash onClick={() => setclickEye(true)} className={`text-[16px] text-[#00000087] absolute right-[8px] top-[14px] cursor-pointer ${clickEye ? "hidden":""}`} />
                    <FaEye onClick={() => setclickEye(false)} className={`text-[16px] text-[#00000087] absolute right-[8px] top-[14px] cursor-pointer ${clickEye ? "":"hidden"}`} />
                  </label>
                </div>
                <div className="mb-[12px] text-left">
                  <label className="relative">
                    ...
                    <FaEyeSlash onClick={() => setclickEye2(true)} className={`text-[16px] text-[#00000087] absolute right-[8px] top-[14px] cursor-pointer ${clickEye2 ? "hidden":""}`} />
                    <FaEye onClick={() => setclickEye2(false)} className={`text-[16px] text-[#00000087] absolute right-[8px] top-[14px] cursor-pointer ${clickEye2 ? "":"hidden"}`} />
                  </label>
                </div>

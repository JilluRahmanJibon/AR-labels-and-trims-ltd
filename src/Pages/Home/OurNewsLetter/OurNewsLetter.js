    ...
    >
      <div className="xl:w-[1100px] w-[100%] grid [@media(min-width:1050px)]:grid-cols-2 grid-cols-1 items-center mx-auto">
        <div className="[@media(min-width:1050)]:w-[500px] [@media(min-width:700)]:w-[500px] [@media(min-width:420)]:w-[97%] w-[99%] GeologicaFont text-[#ffffff] [@media(min-width:490)]:mb-[2rem] mb-[1rem] mx-auto">
            <h1 className="xl:!text-[32px] [@media(min-width:490px)]:text-[28px] [@media(min-width:420px)]:text-[25px] [@media(min-width:400)]:text-[22px] text-[20px] [@media(min-width:490)]:pb-[12px] pb-[7px]">Sign up for our newsletter</h1>
            <p className="[@media(min-width:1050)]:text-[16px] [@media(min-width:490)]:text-[15px] [@media(min-width:400)]:text-[14px] text-[13px] [@media(min-width:490)]:leading-[18px]">Want to keep up to date with industry developments, trends, product launches and more? Sign up to our newsletter to get the latest delivered to your inbox.</p>
        </div>
        <form className="[@media(min-width:1100)]:w-[500px] [@media(min-width:1050)]:w-[400px] [@media(min-width:700)]:w-[600px] [@media(min-width:420)]:w-[97%] w-[99%] [@media(min-width:1050px)]:ml-[1rem] mx-auto">

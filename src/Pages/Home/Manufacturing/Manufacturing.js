          ...
          <div className="container mx-auto px-6">
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                  {steps.map((step, index) => (
                      <div
                          data-aos="fade-up"
                          key={index} className="[@media(min-width:460px)]:w-full w-[280px] flex [@media(min-width:460px)]:flex-row flex-col [@media(min-width:460px)]:items-start items-center [@media(min-width:460px)]:text-left text-center bg-white p-6 rounded-md shadow-[0px_0px_6px_0px_#00000021] mx-auto">
